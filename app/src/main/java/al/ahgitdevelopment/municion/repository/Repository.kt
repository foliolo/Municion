...
class Repository @Inject constructor(private val db: AppDatabase) : RepositoryInterface {
    ...
    override suspend fun getCompetition(): LiveData<List<Competition>>? = db.tiradaDao()?.getCompetitions()
    ...
    override suspend fun saveCompetition(competition: Competition) = db.tiradaDao()?.insert(competition)!!
    ...
    override suspend fun removeCompetition(id: Long) = db.tiradaDao()?.delete(id)!!
