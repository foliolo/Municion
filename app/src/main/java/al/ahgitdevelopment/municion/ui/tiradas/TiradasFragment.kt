...
class TiradasFragment : Fragment() {
    ...
    private val viewModel: TiradasViewModel by viewModels {
        viewModelFactory
    }
...
//                DataBindingUtil.inflate(inflater, R.layout.tiradas_fragment, container, false)
//
//        binding.viewModel = this.viewModel
//        binding.lifecycleOwner = viewLifecycleOwner

        return inflater.inflate(R.layout.tiradas_fragment, container, false)
    }
