...
public class TiradaFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descripcion = (TextInputLayout) findViewById(R.id.form_tirada_descripcion);
        rango = (AppCompatSpinner) findViewById(R.id.form_tirada_rango);
        fecha = (TextInputLayout) findViewById(R.id.form_tirada_fecha);
        puntuacion = (TextInputLayout) findViewById(R.id.form_tirada_puntuacion);
