...
public class Base64 {
     ...
     * @since 1.4
     */
    public static byte[] decode(String s) throws al.ahgitdevelopment.municion.BillingUtil.Base64DecoderException {
    ...
    public static byte[] decode(byte[] source, int off, int len)
            throws al.ahgitdevelopment.municion.BillingUtil.Base64DecoderException {
                ...
                if (sbiDecode >= EQUALS_SIGN_ENC) {
                    ...
                    if (sbiCrop == EQUALS_SIGN) {
                        ...
                        if (b4Posn == 0 || b4Posn == 1) {
                            throw new al.ahgitdevelopment.municion.BillingUtil.Base64DecoderException(
     ...
     * @since 1.3
     */
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, byte[]
            decodabet) {
        // Example: Dk==
