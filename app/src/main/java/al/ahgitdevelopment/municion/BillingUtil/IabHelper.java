...
public class IabHelper {
     ...
     *                        This is used for verification of purchase signatures. You can find your app's
     *                        base64-encoded
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener
            listener) {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            if (purchaseData == null || dataSignature == null) {
                ...
                result = new IabResult(IABHELPER_UNKNOWN_ERROR, "IAB returned null purchaseData or " +
                        "dataSignature");
            ...
            try {
                ...
                if (!Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
                    ...
                    result = new IabResult(IABHELPER_VERIFICATION_FAILED, "Signature verification failed " +
                            "for sku " +
                            sku);
                    if (mPurchaseListener != null)
    ...
    public interface OnIabSetupFinishedListener {
         ...
         */
//        public void onIabSetupFinished(IabHelper result); //FIXME: Lo he cambiado a IabResult
