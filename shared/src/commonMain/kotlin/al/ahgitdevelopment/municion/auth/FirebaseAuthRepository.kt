...
class FirebaseAuthRepository(
    ...
    suspend fun linkWithEmail(email: String, password: String): Result<FirebaseUser> = runCatching {
    ...
    suspend fun migrateFromLegacy(email: String, pin: String): Result<MigrationResult> = try {
    ...
    suspend fun reauthenticate(credential: AuthCredential): Result<Unit> = runCatching {
